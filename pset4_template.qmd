...
# Rename the ZIP code column for consistency
zip_codes = zip_codes.rename(columns={'ZCTA5': 'ZIP_CODE'})

# Filter for Texas ZIP codes based on the first digits ('75', '76', '77', '78')
texas_zip_codes = zip_codes[zip_codes['ZIP_CODE'].astype(str).str.startswith(('75', '76', '77', '78'))]
...
# Count the number of hospitals per ZIP code, using 'ZIP_CD' as the column name
...
# Plot a choropleth map of the number of hospitals by ZIP code
